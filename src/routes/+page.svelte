                  ...
                  <div>
                     ...
                     <nav class="nav hidden lg:block" aria-label="In-page jump links">
                           <ul class="mt-16 w-max">
                              <li><a class="group flex items-center py-3 cursor-none" href="#about"><span class="nav-indicator mr-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none"></span><span class="nav-text text-xs font-bold uppercase tracking-widest text-slate-500 group-hover:text-slate-200 group-focus-visible:text-slate-200">About</span></a></li>
                              ...
                              <li><a class="group flex items-center py-3 cursor-none" href="#projects"><span class="nav-indicator mr-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none"></span><span class="nav-text text-xs font-bold uppercase tracking-widest text-slate-500 group-hover:text-slate-200 group-focus-visible:text-slate-200">Projects</span></a></li>
                           </ul>
                     </nav>
                  </div>
                  <ul class="ml-1 mt-8 flex items-center" aria-label="Social media">
                     <li class="mr-5 shrink-0 text-xs">
                           <a class="block hover:text-slate-200 cursor-none" href="https://github.com/NguyenTrav/" target="_blank" rel="noreferrer noopener" aria-label="GitHub (opens in a new tab)" title="GitHub"><span class="sr-only">GitHub</span>
                     ...
                     <li class="mr-5 shrink-0 text-xs">
                           <a class="block hover:text-slate-200 cursor-none" href="https://www.linkedin.com/in/nguyentrav/" target="_blank" rel="noreferrer noopener" aria-label="LinkedIn (opens in a new tab)" title="LinkedIn"><span class="sr-only">LinkedIn</span>
                     ...
                     <li class="mr-5 shrink-0 text-xs">
                           <a class="block hover:text-slate-200 cursor-none" href="mailto:nguyentrav@gmail.com" target="_blank" rel="noreferrer noopener" aria-label="Gmail (opens in a new tab)" title="Gmail"><span class="sr-only">Gmail</span>
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 220 220" fill="currentColor" class="h-6 w-6" aria-hidden="true"><path d="M108,0C48.353,0,0,48.353,0,108s48.353,108,108,108s108-48.353,108-108S167.647,0,108,0z M156.657,60L107.96,98.498L57.679,60H156.657z M161.667,156h-109V76.259l50.244,38.11c1.347,1.03,3.34,1.545,4.947,1.545c1.645,0,3.073-0.54,4.435-1.616l49.374-39.276V156z"/></svg>
                           </a>
                     </li>
                  </ul>
               </header>
                                       ...
                                       <h3 class="font-medium leading-snug text-slate-200">
                                          <div>
                                             <a class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-green-300 focus-visible:text-green-300  group/link text-base" href="https://www.pragroup.com/" target="_blank" rel="noreferrer noopener" aria-label="Portfolio Recovery Associates (opens in a new tab)">
                                                <span class="cursor-none absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                                <span>
                                                   Full Stack Developer · PRA Group<!-- --> 
                                                   <span class="cursor-none inline-block">
                              ...
                              <div class="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                                 ...
                                 <div class="z-10 sm:col-span-6">
                                    ...
                                    <ul class="mt-2 flex flex-wrap" aria-label="Related links">
                                       <li class="mr-4">
                                          <a class="cursor-none relative mt-2 inline-flex items-center text-sm font-medium text-slate-300 hover:text-green-300 focus-visible:text-green-300" href="https://ricepaper-tasteofvietnam.com/" target="_blank" rel="noreferrer noopener" aria-label="Rice Paper (opens in a new tab)">
                           ...
                           <li class="mb-12">
                              <div class="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                                 ...
                                 <div class="z-10 sm:order-2 sm:col-span-6">
                                    <h3>
                                       <a class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-emerald-300 focus-visible:text-green-300  group/link text-base" href="https://nguyentrav.github.io/lights-out/" target="_blank" rel="noreferrer noopener" aria-label="Lights Out Game (opens in a new tab)">
                                          <span class="cursor-none absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                          <span>
                                             Lights Out Game
                                             <span class="cursor-none inline-block">
