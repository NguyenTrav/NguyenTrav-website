	...
	<div>
	   <section>
		<div class="bg-red-500 sm:bg-orange-500 md:bg-green-500 lg:bg-blue-500 xl:bg-violet-500">Media Query</div>
		  ...
		  <enhanced:img class="mx-auto hidden lg:block lg:w-2/5 xl:w-1/3" src="{cliffjumplg}" alt="cliffjump" loading="lazy"/>
		  <p class="coordinates font-thin tracking-tight text-center pt-2">48°27'32"N 122°36'28"W 2024.06.08</p>
	   </section>
