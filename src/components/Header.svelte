<header class="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-[48%] lg:flex-col lg:justify-between lg:py-24">
    ...
    <ul class="ml-1 mt-8 flex items-center" aria-label="Social media">
       ...
       <li class="mr-5 shrink-0 text-xs">
             <a class="block hover:text-slate-200" href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=nguyentrav@gmail.com" target="_blank" rel="noreferrer noopener" aria-label="Gmail (opens in a new tab)" title="Gmail"><span class="sr-only">Gmail</span>
